          ...
          // j[1] is the data JSON object
        	...
        	// Main car's localization Data
          	...
          	json msgJson;
						...
						for(int i = 0; i < sensor_fusion.size(); i++) {
							...
							if(d < (2 + 4*lane + 2) && d > (2 + 4 * lane - 2))
							{
								...
								check_car_s += ((double)prev_size * .02 * check_speed); //if using previous points can project s value ou...
          	...
          	vector<double> next_y_vals;
						...
						// Calculate how to break up spline points so that we travel at our defined reference velocity
						...
						for (int i = 1; i <= 50 - previous_path_x.size(); i++) {
							...
							double N = (target_dist / (.02 * ref_vel/2.24)); //2.24 to convert mph to m/s
